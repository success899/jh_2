...
function send_input() {
    axios.post('/accounts/hello_world/', {
      ...
      .then(function (response) {
        ...
        document.getElementById('text').innerHTML = response.data['message'];   // 입력받은 text를 찾음
      })
...
axios.get('/accounts/hello_world/')
  .then(function (response) {
    ...
    document.getElementById('text').innerHTML = response.data['message'];   //Return TEXT 를 찾음
